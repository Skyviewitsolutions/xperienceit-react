            ...
            <div className="container-fluid">
              ...
              <div className="row">
               ...
               <div className="baloon-elements">
                  <div className="left_element" data-aos="flip-left" data-aos-duration = "600">
                    <img src={Balloon1} alt="balloons" data-aos="fade-up" data-aos-duration = "600"/>
                  </div>
                  <div className="right_element" data-aos="flip-left" data-aos-duration = "600">
