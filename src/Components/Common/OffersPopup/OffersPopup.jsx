...
const OffersPopup = () =>{
    ...
    <div className="offersPopup">
        ...
        <div className="offersPopup_right">
            <h3>Mohd has given you a 200 Rs discount for  your 
            First Xperience It login .
            </h3>

            <div className="offersPopup_para">
                <p>You will get instant 200 Rs discount on your booking while your friend will receive the credit when you book an Xperience</p>
            </div>

            <button className="offersPopup_btn">
                Sign In To Claim 
            </button>
        </div>
