    ...
    <div className="App">
      <Router>
        <Switch>
          ...
          <Route exact path="/experiences/booking/:location/:parent_name/:parent_id/:package_name/:package_id" component={BookingScreen}/>
          <Route exact path="/all_packages_details" component={AllPackageDetailsScreens}/>
