                ...
                <div className="col-lg-7">
                  <div className="booking_step_left">
                      <div className="product_cancellation" data-aos="fade-right">
                        ...
                        <div className="bookingForm">
                          ...
                          <div className="form2">
                            <div class="row mt-3">
                              <div class="col-sm-12">
                                <p>* How did you come to know about xperience it? </p>
                              </div>
                            ...
                            <div class="row mt-3">
                              ...
                              <div class="form-inline col-lg-4 col-md-4 col-6">
                                <input
                                  ...
                                  name="occas"
                                  id="prtnrbirth"
                                  onChange={(e) => setOccasion("Partner's Birthday")}
                                />
                                <label htmlFor="prtnrbirth">Partner's Birthday</label>
                              </div>
                              <div class="form-inline col-lg-4 col-md-4 col-6">
                                <input
                                  type="radio"
                              ...
                              <div class="form-inline col-lg-4 col-md-4 col-6">
                                <input
                                  ...
                                  name="occas"
                                  id="brosis"
                                  onChange={(e) => setOccasion("For Brother or Sister")}
                                />
                                <label htmlFor="brosis">For Brother or Sister</label>
                              </div>
                              <div class="form-inline col-lg-4 col-md-4 col-6">
                                <input
                                  type="radio"
                      ...
                      <div className="product_About" data-aos="fade-right">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=917080581133&text&type=phone_number&app_absent=0" className="whatsApplogo"><BsWhatsapp /></a>
                        </h5>
                        {"   "}
                        <h5 style={{ marginLeft: "15px", marginTop: "5px" }}>
                          Unable to login or facing Payment issue? <a href="https://api.whatsapp.com/send/?phone=917080581133&text&type=phone_number&app_absent=0" className="whatsAppLink">Click to connect on WhatsApp</a>
                    ...
                    <div className="booking_step_right">
                      <div className="product_arrngmgnt" data-aos="fade-left">
                        ...
                        <div className="customdetails">
                          <span style={{marginBottom : "10px"}} onClick={() => setShowCustomization(true)}>
                        ...
                        {selectedCustomization.length != 0 ? 
                          <div className="">
                            ...
                            {selectedCustomization.map((item,index) =>{
                              ...
                              <h6 className="bkngPrice">Rs {item.price} </h6>
                            </div>
                              </>)
                            })}
                        ...
                        <div
                          ...
                          isLoading={isLoading}
                        >
                          <button type="button" className="ckBtn" isLoading={isLoading}>
                            Checkout
                          </button>
                        </div>
                      </div>
